      ...
      <nav className="hidden items-center gap-6 md:flex">
        {navLinks.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="text-sm font-medium text-gray-300 transition-colors hover:text-[#E30613]"
          >
            {link.label}
          </Link>
        ))}
        ...
        {user ? (
          <div className="relative">
            <button
              ...
              className="flex size-9 items-center justify-center rounded-full bg-[#E30613] text-sm font-bold text-white transition-colors hover:bg-[#c00510]"
              ...
              <>
                ...
                <div className="absolute right-0 z-50 mt-2 w-48 rounded-md border border-white/10 bg-gray-900 py-1 shadow-lg">
                  ...
                  <form action={signOut}>
                    <button
                      type="submit"
                      className="w-full px-4 py-2 text-left text-sm text-gray-300 transition-colors hover:bg-white/5 hover:text-white"
                    >
                      Déconnexion
                    </button>
                  </form>
