      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div>
            <Link href="/" className="inline-block">
              <span className="text-xl font-bold tracking-tight text-white">
                <span className="text-[#E30613]">LFR</span> — Le Football
                Rennais
              </span>
            </Link>
            <p className="mt-4 text-sm leading-relaxed text-gray-400">
              Toute l&apos;actualité du Stade Rennais FC : analyses, vidéos,
              discussions et communauté. Par des passionnés, pour des passionnés
              Rouge et Noir.
            </p>
          </div>
            ...
            <ul className="mt-4 flex flex-col gap-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-400 transition-colors hover:text-[#E30613]"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <p className="text-sm text-gray-500">
            &copy; 2024 Le Football Rennais. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
